...
import { Course, getGradeColor, useGpa } from '../contexts/GpaContext';
...
export default function GpaTrackerScreen() {
  ...
  const handleSubmit = async (courseData: Omit<Course, 'id' | 'createdAt'>) => {
    if (editingCourse) {
          ...
          <View style={[styles.card, styles.breakdownCard]}>
            ...
            <View style={styles.breakdownGrid}>
              {Object.entries(gpaStats.gradeBreakdown).map(([grade, count]) => (
                <View key={grade} style={styles.breakdownItem}>
